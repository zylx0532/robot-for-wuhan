...
DATA_DIR   = os.path.join(PROJECT_DIR, "archive")
...
WX_ROBOT_DATA_DIR         = os.path.join(WX_ROBOT_DIR, "archive")
...
DATA_COUNTRY_DICT_NAME = "global_countries_dict.json"
...
WX_SERVER_DATA_DIR      = os.path.join(WX_SERVERS_DIR, "archive")
